...
#include <cstdint>
using esp_err_t = int;
static const int ESP_OK = 0, ESP_FAIL = -1, ESP_ERR_INVALID_ARG = 0x102;
static const int ESP_ERR_INVALID_STATE = 0x103, ESP_ERR_IMAGE_INVALID = 0x2002;
static const int ESP_PARTITION_TYPE_APP = 0, ESP_PARTITION_SUBTYPE_APP_OTA_0 = 0x10;
